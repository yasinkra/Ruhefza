        ...
        <header className="fixed top-0 left-0 right-0 z-50 xl:hidden">
            <div className="bg-white/95 backdrop-blur-md border-b border-gray-100/80 px-4 h-16 flex items-center justify-between shadow-sm relative">
                ...
                <div className="flex items-center gap-0.5 z-10">
                    ...
                    <Link href="/messages" className="p-2 text-gray-400 hover:text-gray-900 active:scale-95 transition-all relative">
                    ...
                    <Link href="/notifications" className="p-2 text-gray-400 hover:text-gray-900 active:scale-95 transition-all relative">
