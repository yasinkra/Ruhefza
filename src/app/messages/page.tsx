...
function MessagesContent() {
    ...
    return (
        <div className="flex flex-1 h-full overflow-hidden">
            {/* Chat List */}
            <div className={cn(
                "w-full md:w-80 border-r border-slate-200 h-full shrink-0",
            ...
            <div className={cn(
                ...
                {selectedConversationId && selectedPartnerId ? (
                    ...
                    <div className="h-full flex flex-col items-center justify-center text-slate-400 p-4 text-center bg-slate-50/30">
                        <div className="w-20 h-20 bg-gradient-to-br from-sky-100 to-indigo-100 rounded-3xl flex items-center justify-center mb-6 shadow-inner">
                        ...
                        <h3 className="text-lg font-semibold text-slate-600 mb-2">Mesajlarınız</h3>
...
export default function MessagesPage() {
    return (
        <AppShell fullWidth={true}>
            <Suspense fallback={<div className="flex flex-1 h-full items-center justify-center text-slate-400">Yükleniyor...</div>}>
                <MessagesContent />
            </Suspense>
        </AppShell>
    );
